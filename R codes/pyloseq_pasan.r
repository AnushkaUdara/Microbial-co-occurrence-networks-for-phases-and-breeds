...
p <- p + geom_boxplot( alpha=0.2, aes(fill =pH, group=pH))
p <- p + geom_violin( alpha=0.2, aes(fill =pH, group=pH))
p <- p + geom_boxplot( notch=TRUE, alpha=0.2, aes(fill =pH, group=pH))
plot(p)
